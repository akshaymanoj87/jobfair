...
function add() {
  document.getElementById("myj1").style.display=" block";
  document.getElementById("myb21").style.display=" block";
  document.getElementById("myb11").style.display=" none";
  document.getElementById("myb112").style.display=" block";
  
}
function remove() {
  document.getElementById("myj1").style.display=" none";
  document.getElementById("myb21").style.display=" none";
  document.getElementById("myb11").style.display=" block";
  document.getElementById("myb112").style.display=" none";

  
}

function add2() {
  document.getElementById("myj2").style.display=" block";
  document.getElementById("myb212").style.display=" block";
  document.getElementById("myb112").style.display=" none";
  document.getElementById("myb21").style.display=" none";
  document.getElementById("myb113").style.display=" block";
...
function remove2() {
  document.getElementById("myj2").style.display=" none";
  document.getElementById("myb212").style.display=" none";
  document.getElementById("myb112").style.display=" block";
  document.getElementById("myb21").style.display=" block";
  document.getElementById("myb113").style.display=" none";
...
function add3() {
  document.getElementById("myj3").style.display=" block";
  document.getElementById("myb213").style.display=" block";
  document.getElementById("myb113").style.display=" none";
  document.getElementById("myb212").style.display=" none";
  document.getElementById("myb114").style.display=" block";
...
function remove3() {
  document.getElementById("myj3").style.display=" none";
  document.getElementById("myb213").style.display=" none";
  document.getElementById("myb113").style.display=" block";
  document.getElementById("myb212").style.display=" block";
  document.getElementById("myb114").style.display=" none";
...
//   document.getElementById("myb213").style.display=" block";
//   document.getElementById("myb113").style.display="none";
//   // document.getElementById("myb22").style.display="none";
//   document.getElementById("myb212").style.display=" none";
...
//   document.getElementById("myb213").style.display=" none";
//   document.getElementById("myb113").style.display=" block";
//   // document.getElementById("myb22").style.display=" block";
//   document.getElementById("myb212").style.display=" block";
...
function add4() {
  document.getElementById("myj4").style.display=" block";
  document.getElementById("myb214").style.display=" block";
  document.getElementById("myb114").style.display="none";
  // document.getElementById("myb22").style.display="none";
  document.getElementById("myb213").style.display=" none";
...
function remove4() {
  document.getElementById("myj4").style.display=" none";
  document.getElementById("myb214").style.display=" none";
  document.getElementById("myb114").style.display=" block";
  // document.getElementById("myb22").style.display=" block";
  document.getElementById("myb213").style.display=" block";
